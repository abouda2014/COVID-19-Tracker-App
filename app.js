...
async function covid(country) {
  countries.innerHTML = `<option value="WorldWide">WorldWide Pandemic</option>`;
...
btnSearch.addEventListener('click', (d) => {
  d.preventDefault();
  covid(Search.value);
  Search.value = "";
});
